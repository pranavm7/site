---
# title: "Contact Me | Pranav Mahajan"
layout: contact
---
<style>
            ...
            <div class="container">
                <div class="form">
                    ...
                    <form method="POST" data-netlify="true" data-netlify-honeypot="true" name="contact">
                        ...
                        <div class="input__box">
                            <textarea name="message" cols="50" rows="10" placeholder="Message (Optional)"></textarea>
                        </div>
